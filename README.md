...
The additional `"ai-codex-checked"` designation records source checking by the drafting Codex task and a final prose review by a second Codex task. It explicitly disclaims human and Claude factual review; it does not satisfy or alter the Claude condition for `"ai-source-reviewed"`. Follow the separate designation and evidence requirements in `REVIEW.md`.
