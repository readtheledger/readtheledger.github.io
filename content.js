...
<p>Google DeepMind chief Demis Hassabis <a href="https://demishassabis.substack.com/p/a-framework-for-frontier-ai-and-the-dawning-of-a-new-age" target="_blank" rel="noopener noreferrer">outlined another proposal in July</a>: a federally overseen standards body, with independent experts and open-source representatives on its board, funded largely by industry. It would classify the most capable models and initially review them voluntarily up to 30 days before release. A successful system could later become mandatory for US deployment. Models below the frontier threshold would be exempt.</p>
...
<p>A <a href="https://www.pacingthefrontier.com/" target="_blank" rel="noopener noreferrer">July statement from AI-company employees</a> puts the competitive dilemma plainly, requesting government-supported international tools to manage the pace of automated AI development. Individual signatures do not bind their employers.</p>
...
<h2>September 16 update: the price of walking away</h2>
<p><a href="https://app.bchydro.com/accounts-billing/electrical-connections/large-load/emerging-industries-connections.html" target="_blank" rel="noopener noreferrer">BC Hydro says it received 15 applications seeking nearly 800 megawatts</a>. Its updated timetable lists September 16 as the deadline to withdraw without forfeiting bid security; the utility says dates can change.</p>
<p><a href="https://app.bchydro.com/content/dam/BCHydro/customer-portal/documents/accounts-billing/electrical-connections/2026-cfd-request-for-applications.pdf" target="_blank" rel="noopener noreferrer">The application rules require a letter of credit worth $25,000 per requested megawatt</a>. For an illustrative 100-megawatt request, that is $2.5 million in security. Section 12.3 says withdrawal after the deadline forfeits the security, while applicants not selected receive it back. This is security, not an electricity charge or a statement of cash already lost.</p>
<p>The rule puts a financial consequence behind forecasts for AI power demand. <a href="https://app.bchydro.com/accounts-billing/electrical-connections/large-load/emerging-industries-connections.html" target="_blank" rel="noopener noreferrer">The public page does not identify applicants or say how much security remains exposed.</a></p>
...
<h2>Related reading</h2>
<ul><li><a href="/tools/tfsa-room/">Estimate your 2026 TFSA contribution room with the Imperium Post calculator</a>. It is a simplified worksheet for continuous eligibility; it does not assess excess-contribution histories, special distributions or inheritance exceptions.</li><li><a href="/story/led-tfsa-inheritance-2026/">TFSA beneficiary or successor holder? The distinction can change what happens after death</a>.</li></ul>
...
<h2>Related reading</h2>
<ul><li><a href="/story/led-grocery-property-controls-canada/">The supermarket can leave. Its ban on a rival can stay.</a> — why a grocery property restriction can affect competition without guaranteeing a new store or lower prices.</li><li><a href="/story/led-20260817-savers/">What 4.3% expected inflation meant for U.S. cash on August 17, 2026</a> — dated context on inflation expectations and purchasing power.</li></ul>
...
<p><a href="https://river.ai/series-seed-series-a-funding" target="_blank" rel="noopener noreferrer">River AI announced on August 11</a> that it had raised $1.1 billion across what it called its Series Seed and Series A. The company said General Catalyst and AMP PBC led the financing, with strategic investment from Nvidia and AMD Ventures and participation from Y Combinator and Temasek. River had <a href="https://river.ai/introducing-river-ai" target="_blank" rel="noopener noreferrer">introduced itself publicly on June 10</a> and shared an API for training and adapting open models. Those public records do not establish the company’s founding date.</p>
<p>Lovable <a href="https://lovable.dev/blog/series-c" target="_blank" rel="noopener noreferrer">announced a $400 million Series C on August 12</a> at a $13.3 billion valuation. Its <a href="https://lovable.dev/blog/series-b" target="_blank" rel="noopener noreferrer">previous announcement, dated December 18, 2025</a>, said it had raised a $330 million Series B at a $6.6 billion valuation. Dividing 13.3 by 6.6 gives about 2.02, so the later valuation was approximately double the earlier one. The $400 million is the amount Lovable said it raised in the Series C; $13.3 billion is the valuation attached to that round.</p>
<p><a href="https://wisprflow.ai/post/series-b" target="_blank" rel="noopener noreferrer">Wispr’s own August 17 announcement</a> said the voice-software company had raised a $280 million Series B at a $2 billion valuation, led by Menlo Ventures. Wispr said the round brought its total capital raised to $361 million.</p>
...
<p>For a related look at how an AI-spending headline can blur different measures, read our <a href="/story/led-20260817-weekly/">analysis of Microsoft’s capital-spending forecast and accounting note</a>.</p>`,
    sources: [
