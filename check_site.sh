...
for f in index.html content.js sources.js topics.js context.js about.js privacy.js consent.js analytics.js media.js production.js sw.js manifest.webmanifest \
         icon-180.png icon-192.png icon-512.png icon-maskable-512.png \
         sitemap.xml sitemap-news.xml feed.xml robots.txt ads.txt 404.html about/index.html privacy/index.html .nojekyll; do
